...
if __name__ == '__main__':
    ...
    path = os.path.join(Path('C:/Users/Ed/Documents/'),
                        'PNUD/Producto7/Planillas/nuevo\Puren/PLANILLA_INGRESO.xlsx')


    dataFrame = pd.read_excel(path, sheet_name='Espacios de encuentro')
    ...
    for i in range(0, len(dataFrame)):
        ...
        if isinstance(temp, str):
            ...
            category1 = ""
        category2 = "Espacio de encuentro"
        category3 = "eses"
...
with open('dataInstitucionesEspacios.json', 'w', encoding='utf8') as json_file:
